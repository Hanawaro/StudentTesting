#include "db_test_third.hpp"

void db_test_third::add_test(Test& test) {
...
void db_test_third::edit_test(const Test& test) {
    std::ifstream db(m_Path, std::ios::binary);
...
void db_test_third::remove_test(const Test& test) {
    // replace
...
void db_test_third::load_tests(std::vector<Test>& tests) {
    std::ifstream db(m_Path, std::ios::binary);
    db.seekg(0, std::ios::end);
