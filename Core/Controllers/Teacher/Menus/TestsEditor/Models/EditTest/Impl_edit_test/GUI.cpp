...
void EditTest::draw_real_some(const std::string &some) {
    wclear(m_TextBar);
    int row = 1;
    int column = 2;
...
void EditTest::draw_active_text_bar(void) {
    curs_set(1);
}

void EditTest::draw_active_check_bar(void) {
    curs_set(0);
...
void EditTest::draw_active_next_button(void) {
    curs_set(0);
...
void EditTest::draw_active_back_button(void) {
    curs_set(0);
...
void EditTest::draw_active_exit(void) {
    curs_set(0);
